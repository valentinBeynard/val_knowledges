# from core_trigger import CTWSGI
...
def application(environ, start_response):
    ...
    # True if new data are to be passed to trigger_core sever
    data_valid = False
    # Status return to the browser sending the HTTP request
    status = '200 OK'
    output = ""
    ...
    # output = CTWSGI.run(environ, start_response)
